...
public class Facturador extends JFrame {
  ...
  public void initComponent() {
    ...
    setIconImage(
      getToolkit()
        .createImage(
          ClassLoader.getSystemResource("imagenes/icono_factura.png")
        )
    );
    ...
    input_cedula_cliente.setBorder(
    ...
    input_nombres_cliente.setBorder(
    ...
    input_direccion_cliente.setBorder(
      BorderFactory.createEmptyBorder(5, 10, 5, 10)
    );
    restriccion.gridy = 3;
    restriccion.gridx = 1;
    ...
    input_cedula_vendedor.setBorder(
      BorderFactory.createEmptyBorder(0, 10, 0, 10)
    );
    restriccion.gridy = 5;
    restriccion.gridx = 1;
    ...
    input_nombres_vendedor.setBorder(
      BorderFactory.createEmptyBorder(5, 10, 5, 10)
    );
    restriccion.gridy = 6;
    restriccion.gridx = 1;
    ...
    Border borderColor = BorderFactory.createMatteBorder(
      0,
      0,
      1,
      0,
    ...
    input_nombres_vendedor.addKeyListener(evento_Key_vendedor);
  }
  ...
  public void buscarCliente() {
    ...
    for (int i = 0; i < listaUsuarios.length; i++) {
      if (
        ...
        listaUsuarios[i].getRol().equals("CLIENTE") &&
        listaUsuarios[i].getCedula().equals(cedula)
      ) {
  ...
  public void buscarVendedor() {
    ...
    for (int i = 0; i < listaUsuarios.length; i++) {
      if (
        listaUsuarios[i] != null &&
        listaUsuarios[i].getRol().equals("VENDEDOR") &&
        listaUsuarios[i].getCedula().equals(cedula)
      ) {
