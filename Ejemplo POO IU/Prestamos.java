...
public class Prestamos extends JFrame {
  ...
  public void initComponents() {
    ...
    setSize(400, 500);
    setLocationRelativeTo(null); // lo ubica en la mitad de la pantalla
    ...
    btn_calcular.setBackground(new Color(50, 50, 250));
    ...
    etq_plan_pagos.setFont(new Font("Arial", Font.BOLD, 10));
    etq_plan_pagos.setHorizontalAlignment(JLabel.LEFT);
    ...
    btn_limpiar.setBackground(new Color(255, 30, 30));
